<template>
    <van-cell-group class="item" @click="">
        <div class="header-date">
            ...
            <div class="money">
                ...
                <span><b>支</b>23.00</span>
                <span><b>收</b>12.00</span>
            </div>
        </div>
        <van-cell class="expense" title="餐饮" value="-23.00" label="10:00 " @click="goToDetail" />
        <van-cell class="income" title="餐饮" value="+12.00" label="12:00" @click="goToDetail"/>
        <!-- <van-cell
      ...
      :label="`${$filters.transTime(item.date)} | ${item.remark}`"
    /> -->
    </van-cell-group>
</template>
